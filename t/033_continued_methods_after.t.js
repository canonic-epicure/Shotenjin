StartTest(function(t) {
    ...
    use('JooseX.CPS', function () {
        ...
        Class('Base', {
            ...
            methods : {
                ...
                sum : function (param1, param2) {
                    ...
                    t.ok(!this.afterCalled, "'after' modifier wasn't called yet")
                    t.ok(!this.sumBaseCalled, "Base method wasn't called yet")
                    
                    t.ok(this.overrideParams[0] == param1 && this.overrideParams[1] == param2, "Base method was called with correct arguments")
            ...
            continued : {
                ...
                after : {
                    sum : function (param1, param2) {
                        ...
                        t.ok(this.overrideParams[0] == param1 && this.overrideParams[1] == param2, "'after' modifier was called with correct arguments")
                        
                        this.afterParams = arguments
        ...
        //======================================================================================================================================================================================================================================================
        t.diag('Call to continued method modified with after/override')
        ...
        further.sum(1, 1).NEXT(function (res) {
            ...
            t.ok(this.overrideCalled, "'override' modifier was alredy called")
            t.ok(this.afterCalled, "'after' modifier was alredy called")
            t.ok(this.sumBaseCalled, "Base method was alredy called")
